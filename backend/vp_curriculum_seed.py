...
TUTOR NOTE: This final session should feel like a culmination. You have spent significant time building a genuine relationship with this student. Trust that relationship enough to share what you actually believe and care about. The most powerful thing you can model is an engaged, thoughtful, imperfect citizen who keeps trying anyway.""",
    ...
    },
    {
        ...
        'lessons': [
            ...
            {
                'number': 3,
                'title': 'Animals — Core Picture Vocabulary',
                'outline': 'Students learn 12 high-frequency animal words (cat, dog, bird, fish, horse, duck, frog, cow, sheep, rabbit, mouse, monkey) with Spanish meanings, and describe them using "It is a ___" and "I can see a ___", building the picture-vocabulary recognition skill needed for Cambridge Reading & Writing Parts 1-2. Homework: memorize all 12 animals — tested at the start of Lesson 4, including spelling.',
                'vocabulary': [
                    {'word': 'cat', 'definition': 'gato'},
                    {'word': 'dog', 'definition': 'perro'},
                    {'word': 'bird', 'definition': 'pájaro'},
                    {'word': 'fish', 'definition': 'pez'},
                    {'word': 'horse', 'definition': 'caballo'},
                    {'word': 'duck', 'definition': 'pato'},
                    {'word': 'frog', 'definition': 'rana'},
                    {'word': 'cow', 'definition': 'vaca'},
                    {'word': 'sheep', 'definition': 'oveja'},
                    {'word': 'rabbit', 'definition': 'conejo'},
                    {'word': 'mouse', 'definition': 'ratón'},
                    {'word': 'monkey', 'definition': 'mono'},
                ],
                'expressions': [
                    {'expression': 'It is a cat.', 'meaning': 'Picture-description pattern reusing "is" from Lesson 2.'},
                    {'expression': 'I can see a dog.', 'meaning': 'Alternative picture-description pattern.'},
                ],
            },
            {
                'number': 4,
                'title': 'Singular, Plural, This Is / These Are',
                'outline': 'Students learn regular plural nouns (-s), the "a" rule for singular nouns, and "This is a ___" / "These are ___" — the exact sentence pattern used in Cambridge Reading & Writing Part 1 — reusing the animal vocabulary from Lesson 3. Homework: practice singular/plural and This is/These are — tested at the start of Lesson 5.',
                'vocabulary': [
                    {'word': 'a', 'definition': 'Article used before one (singular) thing.'},
                    {'word': 'cats', 'definition': 'Plural of "cat".'},
                    {'word': 'dogs', 'definition': 'Plural of "dog".'},
                    {'word': 'fish', 'definition': 'Plural of "fish" (no change — an exception).'},
                    {'word': 'sheep', 'definition': 'Plural of "sheep" (no change — an exception).'},
                ],
                'expressions': [
                    {'expression': 'This is a cat.', 'meaning': 'Singular picture-description pattern (Cambridge Part 1).'},
                    {'expression': 'These are dogs.', 'meaning': 'Plural picture-description pattern (Cambridge Part 1).'},
                ],
            },
            {
                'number': 5,
                'title': 'Everyday Objects, Colors, Clothes & Descriptions',
                'outline': 'Students learn 8 colors, 4 size/length description words (big, small, long, short), and 5 clothing words (hat, shirt, shoes, dress, socks), describing pictures and clothing using them, reusing the This is/These are pattern from Lesson 4. Homework: memorize the 17 words — tested at the start of Lesson 6.',
                'vocabulary': [
                    {'word': 'red', 'definition': 'rojo'},
                    {'word': 'blue', 'definition': 'azul'},
                    {'word': 'yellow', 'definition': 'amarillo'},
                    {'word': 'green', 'definition': 'verde'},
                    {'word': 'black', 'definition': 'negro'},
                    {'word': 'white', 'definition': 'blanco'},
                    {'word': 'brown', 'definition': 'marrón'},
                    {'word': 'pink', 'definition': 'rosado'},
                    {'word': 'big', 'definition': 'grande'},
                    {'word': 'small', 'definition': 'pequeño/a'},
                    {'word': 'long', 'definition': 'largo/a'},
                    {'word': 'short', 'definition': 'corto/a'},
                    {'word': 'hat', 'definition': 'sombrero'},
                    {'word': 'shirt', 'definition': 'camisa'},
                    {'word': 'shoes', 'definition': 'zapatos'},
                    {'word': 'dress', 'definition': 'vestido'},
                    {'word': 'socks', 'definition': 'calcetines'},
                ],
                'expressions': [
                    {'expression': 'The ball is red.', 'meaning': 'Picture-description pattern: noun + is + color.'},
                    {'expression': 'This is a small box.', 'meaning': 'Picture-description pattern: This is + a + size + noun.'},
                    {'expression': 'The shoes are black.', 'meaning': 'Picture-description pattern applied to clothing.'},
                ],
            },
            {
                'number': 6,
                'title': 'Careful Picture Reading — True/False and Yes/No',
                'outline': 'Students learn a 5-point checklist (object, number, color/description, location, action) for comparing a written sentence to a picture — the core Cambridge Reading & Writing Parts 1-2 skill — practiced using vocabulary from Lessons 3-5. Homework: review the checklist and its vocabulary signals — tested at the start of Lesson 7.',
                'vocabulary': [
                    {'word': 'true', 'definition': 'verdadero — the sentence matches the picture.'},
                    {'word': 'false', 'definition': 'falso — the sentence does not match the picture.'},
                ],
                'expressions': [
                    {'expression': 'This is a yellow bird. (picture: 2 yellow birds) → False.', 'meaning': 'Example of the number-mismatch check from the 5-point checklist.'},
                ],
            },
            {
                'number': 7,
                'title': 'Prepositions of Place',
                'outline': 'Students learn 8 prepositions of place (in, on, under, next to, behind, in front of, between, near) and 4 place words (school, house, park, store), using them together to describe where an animal, person, or object is, completing the location item of the Lesson 6 picture-reading checklist. Homework: memorize all 8 prepositions and 4 place words — tested at the start of Lesson 8.',
                'vocabulary': [
                    {'word': 'in', 'definition': 'dentro de'},
                    {'word': 'on', 'definition': 'encima de / sobre'},
                    {'word': 'under', 'definition': 'debajo de'},
                    {'word': 'next to', 'definition': 'al lado de'},
                    {'word': 'behind', 'definition': 'detrás de'},
                    {'word': 'in front of', 'definition': 'delante de / enfrente de'},
                    {'word': 'between', 'definition': 'entre'},
                    {'word': 'near', 'definition': 'cerca de'},
                    {'word': 'school', 'definition': 'escuela'},
                    {'word': 'house', 'definition': 'casa'},
                    {'word': 'park', 'definition': 'parque'},
                    {'word': 'store', 'definition': 'tienda'},
                ],
                'expressions': [
                    {'expression': 'The cat is under the table.', 'meaning': 'Subject + is + preposition + location, reusing Lesson 3 animal vocabulary.'},
                    {'expression': 'The dog is near the park.', 'meaning': 'Preposition combined with a place word.'},
                ],
            },
            {
                'number': 8,
                'title': 'Spelling & Jumbled Letters',
                'outline': 'Students learn a 4-step spelling strategy (say it slowly, first/last letter, count letters, write in order) and practice spelling and unscrambling 12 words from Lessons 3-5 — directly preparing for Cambridge Reading & Writing Part 3. Homework: practice spelling and unscrambling all 12 words — tested at the start of Lesson 9.',
                'vocabulary': [
                    {'word': 'cat', 'definition': 'gato'},
                    {'word': 'dog', 'definition': 'perro'},
                    {'word': 'bird', 'definition': 'pájaro'},
                    ...
                    {'word': 'cow', 'definition': 'vaca'},
                    {'word': 'duck', 'definition': 'pato'},
                    {'word': 'ball', 'definition': 'pelota'},
                    {'word': 'box', 'definition': 'caja'},
                    {'word': 'book', 'definition': 'libro'},
                    {'word': 'bag', 'definition': 'bolsa'},
                    {'word': 'red', 'definition': 'rojo'},
                    {'word': 'big', 'definition': 'grande'},
                ],
                'expressions': [
                    {'expression': 't-a-c → cat', 'meaning': 'Example of unscrambling jumbled letters into the correct word.'},
                ],
            },
            {
                'number': 9,
                'title': 'People, Family, Body Parts & Possession',
                'outline': 'Students learn 8 people/family words and 9 body-part words, plus "has" and "has got" for describing possession and physical features, reusing vocabulary from earlier lessons. Homework: memorize the 17 words and practice has/has got — tested at the start of Lesson 10.',
                'vocabulary': [
                    {'word': 'boy', 'definition': 'niño'},
                    {'word': 'girl', 'definition': 'niña'},
                    {'word': 'mother', 'definition': 'madre'},
                    {'word': 'father', 'definition': 'padre'},
                    {'word': 'sister', 'definition': 'hermana'},
                    {'word': 'brother', 'definition': 'hermano'},
                    {'word': 'baby', 'definition': 'bebé'},
                    {'word': 'friend', 'definition': 'amigo/a'},
                    {'word': 'head', 'definition': 'cabeza'},
                    {'word': 'hand', 'definition': 'mano'},
                    {'word': 'arm', 'definition': 'brazo'},
                    {'word': 'leg', 'definition': 'pierna'},
                    {'word': 'eye', 'definition': 'ojo'},
                    {'word': 'mouth', 'definition': 'boca'},
                    {'word': 'ear', 'definition': 'oreja'},
                    {'word': 'nose', 'definition': 'nariz'},
                    {'word': 'foot', 'definition': 'pie'},
                ],
                'expressions': [
                    {'expression': 'The girl has a hat.', 'meaning': 'Possession pattern with "has".'},
                    {'expression': 'The dog has got four legs.', 'meaning': 'Possession pattern with "has got" — same meaning as "has".'},
                ],
            },
            {
                'number': 10,
                'title': 'Actions, Toys & Present Continuous',
                'outline': 'Students learn 12 common action verbs (run, walk, sit, stand, play, sing, eat, drink, sleep, read, write, jump) and 4 toy words (ball, doll, kite, car), and use am/is/are + verb-ing to describe actions happening right now — the language needed to describe Cambridge picture-story scenes. Homework: memorize the 12 verbs and 4 toy words, and practice present continuous — tested at the start of Lesson 11.',
                'vocabulary': [
                    {'word': 'run', 'definition': 'correr'},
                    {'word': 'walk', 'definition': 'caminar'},
                    {'word': 'sit', 'definition': 'sentarse'},
                    {'word': 'stand', 'definition': 'pararse'},
                    {'word': 'play', 'definition': 'jugar'},
                    {'word': 'sing', 'definition': 'cantar'},
                    {'word': 'eat', 'definition': 'comer'},
                    {'word': 'drink', 'definition': 'beber'},
                    {'word': 'sleep', 'definition': 'dormir'},
                    {'word': 'read', 'definition': 'leer'},
                    {'word': 'write', 'definition': 'escribir'},
                    {'word': 'jump', 'definition': 'saltar'},
                    {'word': 'ball', 'definition': 'pelota'},
                    {'word': 'doll', 'definition': 'muñeca'},
                    {'word': 'kite', 'definition': 'cometa'},
                    {'word': 'car', 'definition': 'carro/coche'},
                ],
                'expressions': [
                    {'expression': 'She is singing.', 'meaning': 'Present continuous: is/am/are + verb-ing, for actions happening now.'},
                    {'expression': 'The girl is playing with a doll.', 'meaning': 'Present continuous combined with a toy word.'},
                ],
            },
            {
                'number': 11,
                'title': 'Question Words & One-Word Answers',
                'outline': 'Students learn 6 question forms most useful for Cambridge picture-story questions (Who, What, Where, How many, What is ___ doing?, What has ___ got?) and practice giving precise, correctly-spelled one-word answers — directly preparing for Reading & Writing Part 4. Homework: memorize the 6 question forms and their expected answer types — tested at the start of Lesson 12.',
                'vocabulary': [
                    {'word': 'who', 'definition': 'Asks about a person.'},
                    {'word': 'what', 'definition': 'Asks about a thing or action.'},
                    {'word': 'where', 'definition': 'Asks about a place.'},
                    {'word': 'how many', 'definition': 'Asks about a quantity/number.'},
                ],
                'expressions': [
                    {'expression': 'What is the boy doing? → Playing.', 'meaning': 'A picture-story question requiring a one-word answer.'},
                ],
            },
            {
                'number': 12,
                'title': 'Numbers, Food & Factual Vocabulary',
                'outline': 'Students learn the numbers 1-20 (13-19 taught as the "-teen" pattern), 5 food words (apple, banana, egg, milk, bread), and practice answering "How many ___ are there?" — vocabulary that appears constantly in Cambridge counting and factual-text tasks. Homework: memorize numbers 1-20 including spelling, and the 5 food words — tested at the start of Lesson 13.',
                'vocabulary': [
                    {'word': 'one', 'definition': 'uno'},
                    {'word': 'two', 'definition': 'dos'},
                    {'word': 'three', 'definition': 'tres'},
                    {'word': 'four', 'definition': 'cuatro'},
                    {'word': 'five', 'definition': 'cinco'},
                    {'word': 'six', 'definition': 'seis'},
                    {'word': 'seven', 'definition': 'siete'},
                    {'word': 'eight', 'definition': 'ocho'},
                    {'word': 'nine', 'definition': 'nueve'},
                    {'word': 'ten', 'definition': 'diez'},
                    {'word': 'eleven', 'definition': 'once'},
                    {'word': 'twelve', 'definition': 'doce'},
                    {'word': 'thirteen', 'definition': 'trece'},
                    {'word': 'twenty', 'definition': 'veinte'},
                    {'word': 'many', 'definition': 'muchos/as'},
                    {'word': 'some', 'definition': 'algunos/as'},
                    {'word': 'apple', 'definition': 'manzana'},
                    {'word': 'banana', 'definition': 'plátano'},
                    {'word': 'egg', 'definition': 'huevo'},
                    {'word': 'milk', 'definition': 'leche'},
                    {'word': 'bread', 'definition': 'pan'},
                ],
                'expressions': [
                    {'expression': 'How many birds are there? → Three.', 'meaning': 'Counting question and numeric answer.'},
                    {'expression': 'There are three apples.', 'meaning': 'A number combined with a countable food word.'},
                ],
            },
            {
                'number': 13,
                'title': 'Factual Reading, Missing Words & Weather',
                'outline': 'Students learn a 5-step strategy (read, identify topic, identify word type, use context, check spelling) for finding a missing word in a short factual text, plus 4 weather words (sun, rain, hot, cold), applying the strategy to original texts built from Lessons 3-12 vocabulary — directly preparing for Reading & Writing Part 5. Homework: review vocabulary from Lessons 3-12 in preparation for Lesson 14.',
                'vocabulary': [
                    {'word': 'milk', 'definition': 'leche — example missing-word answer (what a cow gives us).'},
                    {'word': 'sun', 'definition': 'sol'},
                    {'word': 'rain', 'definition': 'lluvia'},
                    {'word': 'hot', 'definition': 'caliente / caluroso'},
                    {'word': 'cold', 'definition': 'frío'},
                ],
                'expressions': [
                    {'expression': 'A cow gives us ___. → milk', 'meaning': 'Example of using context to find a missing factual-text word.'},
                    {'expression': 'Today the sun is out and it is hot.', 'meaning': 'A simple factual weather sentence.'},
                ],
            },
            {
                'number': 14,
                'title': 'Picture Stories & Careful Detail Reading',
                'outline': 'Students learn an 8-step process for reading a 3-picture story, tracking what changes between pictures, and answering one-word questions with correct spelling — directly preparing for Reading & Writing Part 4. Homework: complete a full cumulative review of Lessons 1-14 vocabulary and grammar in preparation for the Lesson 15 final review.',
                'vocabulary': [
                    {'word': 'story', 'definition': 'historia — a sequence of pictures showing connected events.'},
                ],
                'expressions': [
                    {'expression': 'Where is the ball? → Under the tree.', 'meaning': 'Tracking a detail (location) that changed between pictures in a story.'},
                ],
            },
            {
                'number': 15,
                'title': 'Final Volume 2 Preparation',
                'outline': 'A cumulative diagnostic review of Lessons 1-14 followed by integrated original practice across all 5 Cambridge Reading & Writing skill types (true/false and yes/no pictures, spelling, picture story, missing words). Homework: the official Cambridge English Pre A1 Starters Reading & Writing sample paper, Volume 2 (Listening not required) — the course\'s final benchmark.',
                'vocabulary': [],
                'expressions': [
                    {'expression': 'Cambridge Pre A1 Starters — Volume 2', 'meaning': 'The final Reading & Writing benchmark this entire course has been building toward.'},
                ],
            },
            {
                'number': 16,
                'title': 'Volume 2 Debrief & Past Tense',
                'outline': 'The lesson opens by reviewing the student\'s Cambridge Volume 2 results, the same way Lesson 3 reviewed Volume 1. Students then learn the simple past tense: the regular -ed rule and its 3 spelling patterns (reusing the Lesson 8 spelling strategy and Lesson 10 action verbs), plus 6 common irregular verbs (go→went, have→had, see→saw, eat→ate, get→got, do→did) that must be memorized rather than derived by rule.',
                'vocabulary': [
                    {'word': 'played', 'definition': 'Past tense of "play" (regular, -ed).'},
                    {'word': 'watched', 'definition': 'Past tense of "watch" (regular, -ed).'},
                    {'word': 'went', 'definition': 'Past tense of "go" (irregular).'},
                    {'word': 'had', 'definition': 'Past tense of "have" (irregular).'},
                    {'word': 'saw', 'definition': 'Past tense of "see" (irregular).'},
                    {'word': 'ate', 'definition': 'Past tense of "eat" (irregular).'},
                    {'word': 'got', 'definition': 'Past tense of "get" (irregular).'},
                    {'word': 'did', 'definition': 'Past tense of "do" (irregular).'},
                ],
                'expressions': [
                    {'expression': 'She is happy because she got a new dog.', 'meaning': 'Irregular past tense in a real, natural sentence, reusing "happy" from Lesson 1 and "dog" from Lesson 3.'},
                ],
            },
            {
                'number': 17,
            ...
            },
            {
                ...
                'expressions': [
                    {'expression': 'She is happy because she got a new dog.', 'meaning': 'Combining an emotion, a reason (because), and irregular past tense in one natural sentence.'},
                ],
            },
            {
                'number': 19,
                'title': 'Reading Comprehension — Putting It All Together',
                'outline': 'Students read "Maria\'s Day," a short original passage built entirely from course vocabulary and grammar (family, animals, colors/clothes, weather, past tense, because, going to/will), then answer comprehension questions, consolidating everything learned so far.',
                'vocabulary': [],
                'expressions': [],
            },
            {
                ...
                'outline': 'A capstone conversation lesson where students use pronouns, tenses, vocabulary, and questions together in free conversation, with a full course review spanning emotions through Volume 2 preparation to past/future/connectors.',
                'vocabulary': [],
                'expressions': [],
            },
        ]
...
def seed_curriculum(db):
    """Creates each curriculum/lesson on first run, and — like apply_lesson_data_v2
    does for lesson_data — always re-syncs title/outline/vocabulary/expressions from
    this authored data on every startup, so revising a lesson here actually reaches
    the database on the next deploy instead of only applying to brand-new rows."""
    for curr_data in CURRICULUM_DATA:
        curriculum = db.query(models.VPCurriculum).filter(models.VPCurriculum.level == curr_data['level']).first()
        if not curriculum:
        ...
        for lesson_data in curr_data['lessons']:
            lesson = db.query(models.VPCurriculumLesson).filter_by(
                curriculum_id=curriculum.id, lesson_number=lesson_data['number'],
            ).first()
            is_new_lesson = lesson is None
            if is_new_lesson:
            ...
            lesson.outline = lesson_data['outline']
            if is_new_lesson:
                db.add(lesson)
                db.flush()
            hw = db.query(models.VPHomeworkAssignment).filter_by(lesson_id=lesson.id).first()
            if not hw:
                hw = models.VPHomeworkAssignment(lesson_id=lesson.id)
                db.add(hw)
            hw.vocabulary = json.dumps(lesson_data['vocabulary'])
            hw.expressions = json.dumps(lesson_data['expressions'])
        db.commit()
